...
// ── renderNavbar — agora apenas injeta o mini-header nas páginas internas ──
// Chama com: window.renderNavbar('tarefas') nas páginas que não são o dashboard
// No dashboard chama com: window.renderNavbar('dashboard') — não aparece o botão voltar
window.renderNavbar = function(activePage) {
  // Dashboard não precisa de mini-header — tem a sua própria barra de nav-links
  ...
  // Injetar estilos do mini-header (uma única vez)
  if (!document.getElementById('miniHeaderStyle')) {
    ...
    style.textContent = `
      ...
      .mini-header-back {
        ...
        padding:5px 12px; border:1px solid #e2e2e8;
        border-radius:8px; font-size:10px; text-transform:uppercase;
        letter-spacing:.07em; color:#8888a0; text-decoration:none;
        font-family:'DM Mono',monospace; background:#f7f7f9;
      ...
      .mini-header-title {
        ...
        font-size:13px; letter-spacing:-.02em; color:#1a1a22;
        flex:1;
      }
      ...
      .mini-header-role {
        ...
        padding:2px 8px; border-radius:10px; font-weight:500; white-space:nowrap;
      }
      ...
      .mini-header-logout {
        ...
        padding:5px 10px; border:1px solid #e2e2e8; background:none;
        font-family:'DM Mono',monospace; font-size:10px;
        text-transform:uppercase; letter-spacing:.07em;
        color:#8888a0; border-radius:8px; cursor:pointer; transition:all .15s;
      }
